...
### `pelican_director_map_items_total`
  ...
  | Label Values | Description     |
  |--------------|-----------------|
  | `healthTestUtils`     | Health test utilities   |
  | `filteredServers`      | Filtered servers    |
  | `serverStatUtils`      | Server stat utilities    |
  | `serverStatEntries`      | Server stat entries    |
...
### `pelican_director_ttl_cache`
  ...
  | Label Values | Description     |
  |--------------|-----------------|
  | `serverAds`     | Server advertisements   |
...
### `pelican_director_server_count`
  ...
  | Label Values | Description     |
  |--------------|-----------------|
  | `true`     | The server is from the OSDF topology   |
  | `false`      | The server is not from the OSDF topology    |


### `pelican_director_client_version_total`

  The total number of requests from client versions.

  #### Label: `version`

  The version of the client. This label can take on the value of `unknown` if the client version is not recognized.
  It can also take on the value of `pelican-future` if the client version is newer than the director's version.

  #### Label: `service`

  The Pelican service that originated the request.


### `pelican_director_redirections_total`

  The total number of redirections the director issued.
  ...
  #### Label: `version`
  The version of client being redirected.


  #### Label: `network`
  The masked version of the client's IP address.
...
### `pelican_director_rejected_advertisements`
  ...
  #### Label: `hostname`
  The hostname of the server that was rejected.
